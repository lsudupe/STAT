...
```{r figure_6, fig.align='center', echo = F, fig.cap="\\label{fig:figure_6}PM10 prediction values in Poland"}
...
The limitation of the study is the temporal absence, the data had been measured more years but for this study we only use 2019 data.
