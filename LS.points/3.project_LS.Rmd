...
For the missing values in the covariate,
...
```{r figure_3,fig.align='center', echo = F, fig.cap="\\label{fig:figure_3}XXXXXX"}
...
```{r figure_5,fig.align='center', echo = F, fig.cap="\\label{fig:figure_5}Intersity of kingfisher ocurrence"}
